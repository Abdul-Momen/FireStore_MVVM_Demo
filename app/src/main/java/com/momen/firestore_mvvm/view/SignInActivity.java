...
import com.momen.firestore_mvvm.model.SignInUser;
import com.momen.firestore_mvvm.viewmodel.SignInViewModel;
...
public class SignInActivity extends AppCompatActivity {
    ...
    private void signInMethod() {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("899436760885-pmgo30nhsk0l2rolnlcs3qiv1nutd778.apps.googleusercontent.com")
                .requestEmail()
                .build();
